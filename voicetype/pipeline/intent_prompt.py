...
4. 繁体→简体
5. 【关键】人称代词绝对不变：你/我/他/她/它/咱们/他们 等人称代词必须原样保留，不要做任何转换
6. 【关键】锁定标签内容绝对保留：如果输入包含 <lock>XXX</lock>，必须原样保留 XXX，绝对不要修改
7. 【关键】英文和技术术语保留：如果输入中已包含正确的英文单词（如 Claude、API、user_id、PocketFlow 等），必须原样保留，绝对不要改回中文或其他形式
8. 【关键】语法规范：确保输出为标准中文，无语法错误，句子流畅连贯
9. 【关键】避免冗余：删除多余的"起""了""的"等字，如"没有起生效"→"没有生效"，"有在做"→"在做"
</rules>
